"""
Django settings for OpenShopAPI project.
...
SECRET_KEY = 'django-insecure-gurgrp(-nxrf4s+_63r!0o+5&qxinbk(&x7qx7s$=fem@7rkay'
...
WSGI_APPLICATION = 'OpenShopAPI.wsgi.application'
